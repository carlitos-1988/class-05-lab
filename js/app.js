...
function sum(a, b) { //eslint-disable-line
  let actualSum = a+b;
  return [actualSum, 'The sum of 4 and 7 is 11.'];
}
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  let firstStrng = '4 and 7 and 5 sum to 16.';
  let secondString = 'The product of 4 and 7 and 5 is 140.';
  return [sumOfThree, productOfThree, firstStrng, secondString];
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  let stringForArray = '2,3,4 was passed in as an array of numbers, and 9 is their sum.';
  let sumOfNumbers = 0;
  for(let i=0; i< sumArr.length; i++){
    sumOfNumbers = sum(sumOfNumbers,sumArr[i])[0];
    //console.log(sumOfNumbers);
  }
  //console.log(sumOfNumbers[0]);
  return [sumOfNumbers,stringForArray];
...
an array whose first element is the product of those numbers, and 
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  let stringArray = 'The numbers 1,2,3,4,5 have a product of 120.';
  let result = dynamicArray[0];
